...
-- -----------------------------------------------------
-- Schema ncdmb_budgetportal
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ncdmb_budgetportal` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `ncdmb_budgetportal` ;

-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`TP_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`TP_types` (
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`claim_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`claim_types` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`training_location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`training_location` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`training_venues`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`training_venues` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`feeding_periods`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`feeding_periods` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`travel_accomodation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`travel_accomodation` (
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`process_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`process_status` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`budget_heads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`budget_heads` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  ...
  CONSTRAINT `fk_budget_heads_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `ncdmb_budgetportal`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_budget_heads_process_status1`
    FOREIGN KEY (`process_status_id`)
    REFERENCES `ncdmb_budgetportal`.`process_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`contractor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`contractor` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  `email` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`sub_budget_head`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`sub_budget_head` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  ...
  CONSTRAINT `fk_sub_budget_head_budget_heads1`
    ...
    REFERENCES `ncdmb_budgetportal`.`budget_heads` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`department` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`sub_budget_head_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`sub_budget_head_details` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_sub_budget_head_details_sub_budget_head1`
    ...
    REFERENCES `ncdmb_budgetportal`.`sub_budget_head` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sub_budget_head_details_department1`
    FOREIGN KEY (`department_id`)
    REFERENCES `ncdmb_budgetportal`.`department` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_sub_budget_head_details_contractor1`
    ...
    REFERENCES `ncdmb_budgetportal`.`contractor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`Password_reset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`Password_reset` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`expenditure`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`expenditure` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `amount` DECIMAL(10,3) NULL,
  `date` DATETIME NULL,
  ...
  CONSTRAINT `fk_expenditure_sub_budget_head_details1`
    ...
    REFERENCES `ncdmb_budgetportal`.`sub_budget_head_details` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`borrow_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`borrow_request` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`role` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `role_no` INT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`travel_feeding`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`travel_feeding` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `day_no` INT NULL,
  ...
  CONSTRAINT `fk_travel_feeding_feeding_periods1`
    ...
    REFERENCES `ncdmb_budgetportal`.`feeding_periods` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`training`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`training` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`training_TP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`training_TP` (
  `id` INT NOT NULL,
  `cost` DECIMAL(10,3) NULL,
  ...
  CONSTRAINT `fk_training_TP_TP_types1`
    ...
    REFERENCES `ncdmb_budgetportal`.`TP_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_training_TP_training1`
    FOREIGN KEY (`training_id`)
    REFERENCES `ncdmb_budgetportal`.`training` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`claim`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`claim` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_claim_claim_types1`
    ...
    REFERENCES `ncdmb_budgetportal`.`claim_types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`refund`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`refund` (
  `id` INT NOT NULL,
  `training_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `ncdmb_budgetportal`.`sub_budget_head_details_has_borrow_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ncdmb_budgetportal`.`sub_budget_head_details_has_borrow_request` (
  `sub_budget_head_details_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_sub_budget_head_details_has_borrow_request_borrow_request1`
    ...
    REFERENCES `ncdmb_budgetportal`.`borrow_request` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
